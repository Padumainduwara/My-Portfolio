...
const skills = [
  "React", "Next.js", "Node.js", "TypeScript", "Tailwind CSS", "Bootstrap", "Git", "REST APIs", "Figma", "Python", "Framer Motion", 
...
export default function SkillsMarquee() {
  return (
   <section className="py-8 border-y border-white/5 bg-black/80 relative overflow-hidden backdrop-blur-md">
